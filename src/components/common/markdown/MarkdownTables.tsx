...
/**
 * Formats every table-like block in markdown while preserving non-table content.
 */
...
/**
 * Normalizes a markdown table block into aligned columns.
 */
...
/**
 * Finds the contiguous table block around the current cursor position.
 */
