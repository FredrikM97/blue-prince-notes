...
import { SuggestionSourcesContext, useSuggestionSources } from "@/hooks/useSuggestionSources";
...
function SuggestionSourcesBoundary({ children }: { children: React.ReactNode }) {
  const sources = useSuggestionSources();
  return (
    <SuggestionSourcesContext.Provider value={sources}>
      {children}
